...
var s = 'A,B,A,C,B,A,C,A,C,B.L,12,L,8,L,8.L,12,R,4,L,12,R,6.R,4,L,12,L,12,R,6.n.';
// console.log(s.split(''));

var obj = {
    str: '',
    inp: 'A,B,A,C,B,A,C,A,C,B.L,12,R,4,L,12,R,6.R,4,L,12,L,12,R,6.n.',
    real: s.split(''),
    input: '65 44 66 44 65 44 67 44 66 44 65 44 67 44 65 44 67 44 66 10 76 44 49 50 44 76 44 56 44 76 44 56 10 76 44 49 50 44 82 44 52 44 76 44 49 50 44 82 44 54 10 82 44 52 44 76 44 49 50 44 76 44 49 50 44 82 44 54 10 110 10'.split(' ')
}
...
em.on('output', (data, obj) => {
    ...
    // //         break;
    // //     default:
    // //         console.log(`Unrecognised character: ${data}`);
    // //         char = 'AAAA';
    // // }
    // obj.str += String.fromCharCode(data);
});
...
var str = obj.str.split('\n');
var grid = [];
for (var strPart of str) {
    if (strPart.length > 0) grid.push(strPart.split(''));
}
...
var input = '65 44 66 44 65 44 67 44 66 44 65 44 67 44 65 44 67 44 66 10 76 44 12 44 76 44 8 44 76 44 8 10 76 44 12 44 82 44 4 44 76 44 12 44 82 44 6 10 82 44 4 44 76 44 12 44 76 44 12 44 82 44 4 10';
var inputa = '76 44 12 44 76 44 8 44 76 44 8 10 '
var inputb = '76 44 12 44 82 44 4 44 76 44 12 44 82 44 6 10 '
var inputc = '82 44 4 44 76 44 12 44 76 44 12 44 82 44 4 10 '
